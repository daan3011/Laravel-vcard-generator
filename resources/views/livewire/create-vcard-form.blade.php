                                    ...
                                    @if ($currentPage === 1)
                                        <div class="flex flex-col">
                                            <div class="w-full py-2">
                                                ...
                                                <input wire:model.lazy="firstName" type="text" name="first_name"
                                            ...
                                            <div class="w-full py-2">
                                                ...
                                                <input wire:model.lazy="lastName" type="text" name="last_name"
                                            ...
                                            <div class="w-full py-2">
                                                <label for="email_address"
                                                    ...
                                                    address</label>
                                                <input wire:model.lazy="email" type="text" name="email_address"
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <div class="w-full py-2">
                                                <label for="password_confirmation"
                                                    ...
                                                    Password</label>
                                                <input wire:model.lazy="confirmPassword" type="password"
